...
class BootStrap {
    ...
    List<Object> listServers() {
        ...
        provincialServerList.add(new LinkedHashMap(id: '7036157a-61c3-4515-9ab8-fc68359d9402', code: '13', urlPath: 'http://10.1.1.11:', port: '8099', destination: 'CENTRAL_TOOL', type: 'PROD'))
